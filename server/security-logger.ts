...
export enum SecurityEventType {
  ...
  PREFERENCE_ACCESS_ERROR = 'PREFERENCE_ACCESS_ERROR',
  PREFERENCE_UPDATE_ERROR = 'PREFERENCE_UPDATE_ERROR',
  PREFERENCE_DELETE_ERROR = 'PREFERENCE_DELETE_ERROR',
  PREFERENCE_CLEANUP = 'PREFERENCE_CLEANUP',
  PREFERENCE_CLEANUP_ERROR = 'PREFERENCE_CLEANUP_ERROR',
  PREFERENCE_MIGRATION = 'PREFERENCE_MIGRATION',
  PREFERENCE_MIGRATION_ERROR = 'PREFERENCE_MIGRATION_ERROR',
  PREFERENCE_STATS_ERROR = 'PREFERENCE_STATS_ERROR'
}
