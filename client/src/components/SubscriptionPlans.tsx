            ...
            >
              ...
              >
                ...
                <CardHeader className="items-center text-center pt-10 pb-8 space-y-3">
                  ...
                  <div
                    className={`flex h-12 w-12 items-center justify-center rounded-full shadow-sm ring-1 ring-black/5 dark:ring-white/10 ${tier.iconWrapperClass || DEFAULT_ICON_WRAPPER_CLASS}`}
                  >
                    {getTierIcon(tier.id)}
                  </div>
