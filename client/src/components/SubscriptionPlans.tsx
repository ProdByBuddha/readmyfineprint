...
const SUBSCRIPTION_TIERS: SubscriptionTier[] = [
  {
    ...
    limits: {
      ...
      tokensPerDocument: 1000000, // GPT-4.1-nano context limit
  ...
  },
  {
    ...
    name: "Starter",
    description:
      "For individuals and teams who need enhanced AI with superior performance",
    model: "gpt-4.1-mini",
    monthlyPrice: 12,
    yearlyPrice: 120,
    features: [
  ...
  },
  {
    ...
    name: "Professional",
    description:
      "For professionals who need flagship AI with advanced reasoning",
    model: "gpt-4.1",
    monthlyPrice: 49,
    yearlyPrice: 490,
    features: [
