...
export function LegalDisclaimer({ onAccept }: LegalDisclaimerProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={() => {}}>
      <DialogContent className="w-[95vw] h-[90vh] max-w-none max-h-none p-0 m-0" hideCloseButton>
        <div className="flex flex-col h-full">
          <DialogHeader className="px-4 py-3 border-b shrink-0">
            ...
            <DialogDescription className="text-sm">
              Please read and acknowledge the following important information before using ReadMyFinePrint.
            </DialogDescription>
          </DialogHeader>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-gray-700 dark:text-gray-300">
                        ...
                        this service at your own risk and should not rely solely on AI analysis for
                        important legal or financial decisions.
                      </p>
                    </div>
                  </div>
                </CardContent>
          ...
          <DialogFooter className="px-4 py-3 border-t shrink-0 space-y-2">
