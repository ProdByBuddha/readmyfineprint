      ...
      <MobileAppWrapper>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          ...
          <section className="text-center mb-12" role="banner" aria-labelledby="main-heading">
            <h1 id="main-heading" className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4">
          ...
          <section className="mb-16">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card className="text-center p-6">
                ...
                <h3 className="text-xl font-semibold text-card-foreground mb-3">Secure Processing</h3>
              ...
              <Card className="text-center p-6">
                ...
                <h3 className="text-xl font-semibold text-card-foreground mb-3">Instant Analysis</h3>
                <p className="text-muted-foreground">
              ...
              <Card className="text-center p-6">
                ...
                <h3 className="text-xl font-semibold text-card-foreground mb-3">Plain English</h3>
                <p className="text-muted-foreground">
